...
class LibPSGCRegions extends Seeder
{
    protected $excelFilePath = 'public/system-db-libraries/lib_psgc_regions.xls'; // Set the path to your Excel file
    protected $table = 'lib_psgc_regions'; // Set the name of the database table
