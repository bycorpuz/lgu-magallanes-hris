                ...
                <form wire:submit.prevent="{{ $isUpdateMode ? 'update' : 'store' }}">
                    ...
                    <div class="row modal-body">
                        ...
                        <div class="col-md-3 mb-3" wire:ignore>
                            ...
                            <select class="form-select select2" wire:model="extname" data-placeholder="Select" id="extname">
                        ...
                        <div class="col-md-3 mb-3" wire:ignore>
                            ...
                            <select class="form-select select2" wire:model="sex" data-placeholder="Select" id="sex" required>
                                <option value="">Select</option>
                        ...
                        <div class="col-md-3 mb-3" wire:ignore>
                            ...
                            <select class="form-select select2" wire:model="civil_status" data-placeholder="Select" id="civil_status" required>
                                <option value="">Select</option>
